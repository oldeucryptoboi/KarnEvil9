...
import type { Task, Plan, PlanResult, Planner, ToolSchemaForPlanner, UsageMetrics } from "@openvger/schemas";
...
function buildSystemPrompt(
  ...
  return `You are an execution planner for OpenVger, a deterministic agent runtime.
...
function buildAgenticSystemPrompt(
  ...
  return `You are an iterative execution planner for OpenVger, a deterministic agent runtime.
