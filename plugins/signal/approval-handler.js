/**
 * ApprovalHandler — text-based numbered menu for permission requests via Signal.
 */
...
export class ApprovalHandler {
   ...
   */
  constructor({ signalClient, apiBaseUrl, apiToken, logger }) {
